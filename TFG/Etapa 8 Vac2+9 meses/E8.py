...
pacientes_infectados = df[df.iloc[:, 119] == 1]  # Filtrar pacientes infectados con valor 1 en columna 43, PACIENTES INFECTADOS
pacientes_enfermos = df[df.iloc[:, 120] == 1]  # Filtrar pacientes enfermos con valor 1 en columna 44, PACIENTES ENFERMOS
...
media_anticuerpos_2040 = df.loc[(edades >= 20) & (edades <= 40)].iloc[:,191].mean()
media_anticuerpos_4060 = df.loc[(edades > 40) & (edades <= 60)].iloc[:, 191].mean()
media_anticuerpos_6080 = df.loc[(edades > 60) & (edades <= 80)].iloc[:, 191].mean()
media_anticuerpos_80plus = df.loc[edades > 80].iloc[:, 191].mean()
